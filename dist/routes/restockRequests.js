...
router.post('/', async (req, res) => {
    try {
        ...
        const presentacionExists = material.presentaciones.some((p) => p.nombre === presentacion);
...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (notasInternas !== undefined)
            request.notasInternas = notasInternas;
...
//# sourceMappingURL=restockRequests.js.map